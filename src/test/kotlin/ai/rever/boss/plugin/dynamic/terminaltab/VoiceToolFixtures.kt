 ...
 * 2026-07-28 (`tools/list` over the streamable endpoint): 120 tools, of which 13
 * are BossTerm's own.
 *
 * Checked in as a fixture because the safety classification is a claim about THIS
 * surface, and a claim about a surface nobody wrote down is untestable. It will go
 * stale as plugins come and go — which is the point of the tests that read it:
 * they assert properties of the rules (nothing benign is withheld, every
 * destructive tool the descriptions describe is gated), so a name added here
 * either satisfies them or has found a real gap.
 */
internal val LIVE_BOSS_TOOL_NAMES: List<String> = listOf(
    ...
    "docker_restart", "docker_rm", "docker_start", "docker_stop", "download_cancel", "download_open",
    "download_pause", "download_resume", "downloads_clear_completed", "downloads_list",
    "editor_detect_language", "editor_read_file", "editor_write_file", "evolver_create_issue",
    "evolver_evolve", "evolver_hot_reload", "evolver_list_tools", "evolver_open", "evolver_probe",
    "flow_add_node", "flow_connect", "flow_create", "flow_get", "flow_list", "flow_result",
    "flow_run", "flow_status", "get_active_tab", "get_last_command", "git_checkout",
    "git_cherry_pick", "git_discard", "git_log", "git_revert", "git_stage", "git_stage_all",
    "git_status", "git_unstage", "git_unstage_all", "list_panes", "list_tabs", "llmrpa_run",
    "llmrpa_status", "manage_tools", "my_secret_get", "my_secrets_list", "performance_gc",
    "performance_network", "performance_plugin_memory", "performance_snapshot", "permission_create",
    "permissions_list", "plugin_disable", "plugin_enable", "plugins_list", "prompt_get",
    "prompt_list", "prompt_upsert", "read_debug_console", "read_scrollback", "role_create",
    "role_delete", "role_grant_permission", "role_permissions", "role_revoke_permission",
    "roles_list", "rpa_record_clear", "rpa_record_status", "rpa_record_toggle", "rpa_run",
    "rpa_status", "rpa_stop", "run_command", "run_config_list", "run_config_run", "run_in_panel",
    "run_in_sidebar", "search_output", "secret_create", "secret_delete", "secret_get",
    "secret_search", "secrets_list", "send_input", "send_signal", "show_image", "tab_close",
    "tab_focus", "tab_open_url", "tabs_list", "user_role_assign", "user_role_remove", "user_search",
    "users_list",
)
