// Temporary source override of BossTerm v1.2.167 ImageRenderer (Apache-2.0).
// Keep its public JVM API intact. Remove when bundled BossTerm decodes through host Compose.
// Source: https://github.com/kshivang/BossTerm/blob/v1.2.167/compose-ui/src/desktopMain/kotlin/ai/rever/bossterm/compose/rendering/ImageRenderer.kt
