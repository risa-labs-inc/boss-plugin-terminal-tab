...
// 2.5.11: auto-bumped bundled BossTerm to 1.2.127
// (release notes: https://github.com/kshivang/BossTerm/blob/main/docs/release-notes/v1.2.127.md).
version = "2.5.11"
...
// 1.2.127: auto-bumped bundled BossTerm (release notes: https://github.com/kshivang/BossTerm/blob/main/docs/release-notes/v1.2.127.md).
